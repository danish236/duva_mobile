...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Future<void> _completeOnboarding() async {
    // SECURITY GUARD: Ensure DOB is picked
    ...
    // SECURITY GUARD: Ensure interests are picked
    ...
    try {
      // SECURITY GUARD: Ensure user is logged in
      ...
      // 3. Save Interests
      final interestInserts = _selectedInterestIds
          .map(
            (interestId) => {'profile_id': user.id, 'interest_id': interestId},
          )
          .toList();
      ...
      if (mounted) {
        // Look for the "error" key from Cloudflare, fallback to generic network message
  ...
  void _nextPage() {
    if (_currentPage == 0 &&
        (_firstNameController.text.isEmpty || _selectedDate == null)) {
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${_selectedInterestIds.length} / 5 selected',
                ...
                : SingleChildScrollView(
                    child: Wrap(
                      ...
                      children: _masterInterests.map((interest) {
                        final bool isSelected = _selectedInterestIds.contains(
                          interest['id'],
                        );
                        return FilterChip(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'Upload up to 3 images. The first will be your main profile picture.',
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: _isLoading
              ...
              : Text(
                  _currentPage < 3 ? 'Continue' : 'Complete Profile',
