              ...
              _buildGlassContainer(
                child: Column(
                  children: [
                    ...
                    _buildListTile(Icons.cookie_outlined, 'Cookie Policy', colorScheme: colorScheme, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const InfoScreen(docType: 'cookie')))),
                    Divider(height: 1, color: colorScheme.onSurface.withValues(alpha: 0.1)),
                    _buildListTile(Icons.security, 'Privacy & Security', colorScheme: colorScheme, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const InfoScreen(docType: 'privacy')))),
                  ],
                ),
              ),
